...
export default function BackendPreview() {
  ...
  const missionLinks = isFresh ? `${fleet.filter(vehicle => vehicle.mavlink).length}/${fleet.length} mission links` : "Mission link status unavailable";
