...
export default function CommandCenter() {
  ...
  const stale = hasReceived && !isFresh;
  const source =
    state.adapter === "local"
      ...
      >
        ...
        <div className="mission-main">
          <header className="workspace-header">
            ...
            <button
              className={`connection-pill ${isFresh ? "is-live" : stale ? "is-stale" : ""}`}
      ...
      {v ? (
        <dl className="facts">
          ...
          <Fact
            label="Battery"
            value={
              v.battery_remaining == null
                ? "Unavailable"
                : `${fmt(v.battery_remaining)}%`
            }
          />
