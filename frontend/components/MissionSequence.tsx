...
const phases: Record<string, { title: string; step: number; detail: string }> = {
  ...
  drone_track: { title: "Drone contact tracking", step: 3, detail: "The receiving aircraft confirmed the contact. Evaluation below checks the track against the boat." },
  air_track: { title: "Drone tracking confirmed", step: 3, detail: "Fresh aircraft observations maintain the track, including outside tower view." },
